"""
Model Sentiment Visualization - DeepLOB Model Prediction Visualization.

This module enables visualization of DeepLOB model predictions alongside price data,
showing the proportions of different prediction categories (down, stable, up) over time 
using stacked bar charts. The module creates interactive visualizations that help in 
understanding the model's behavior and predictive patterns over various time intervals.

The visualizations include:
1. A price chart showing actual market price movements
2. A stacked bar chart showing the proportion of different prediction classes
   (down, stable, up) for each time window

These visualizations help in analyzing the model's predictive performance and 
identifying patterns in prediction distribution over time.
"""

# Standard library imports
import os         # File path handling and directory operations
import time       # Performance timing and measurement

# Data manipulation and analysis
import numpy as np     # Numerical operations and array handling
import pandas as pd    # DataFrame operations and time series handling

# Data visualization libraries
from plotly.subplots import make_subplots    # Creating multi-panel plots
import plotly.graph_objects as go           # Interactive plotting components
from glob import glob                       # File pattern matching for finding prediction files
